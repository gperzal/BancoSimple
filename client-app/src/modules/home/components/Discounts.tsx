...
const discounts = [
  {
    ...
    icon: "/img/discounts/McDonalds.svg",
    isNew: true,
    isOnline: false,
    isPresential: true,
  },
  ...
  },
  {
    ...
    icon: "/img/discounts/EcoMarket.svg",
    isNew: true,
    isOnline: false,
    isPresential: true,
  },
  {
    ...
    icon: "/img/discounts/Cinemark.svg",
    isNew: false,
    isOnline: true,
    isPresential: true,
  },
